...
from instructions import txt_instruction, txt_test1, txt_test1, txt_test3, txt_sits
...
class InstrScr(Screen):
    def __init__(self, **kwargs):
        ...
        lbl2 = Label(text='Введите возвраст:', halign='right')
        self.in_age = Button(text='7', multiline=False)
...
class PulseScr2(Screen):
    def __init__(self, **kwargs):
        ...
        line2 = BoxLayout(size_hint=(0.8, None), height='30sp')
        lbl_result2 = Label(text='Pезультат после отдыxа:', halign='right') 
        ...
        self.btn = Button(text='3aвeршить', size_hint=(0.3, 0.2), pos_hint={'center_x': 0.5}) 
        self.btn.on_press = self.next
        outer = BoxLayout(orientation='vertical', padding=8, spacing=8)
        outer.add_widget(instr)
